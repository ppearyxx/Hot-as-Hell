            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                if (mysqli_num_rows($result) > 0) {
                    foreach ($result as $row) {
                        ...
                        echo "<td>";
                        echo "<a href='EditPosition.php?id=".$row["PositionID"]."'><button style='color: white; border-radius: 5px; background-color: #00868D; padding: 5px; border: none;'>Edit</button></a> ";
                        echo "<a href='DeletePosition.php?id=".$row["PositionID"]."'><button style='color: white; border-radius: 5px; background-color: #DC3545; padding: 5px; border: none;'>Delete</button></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {

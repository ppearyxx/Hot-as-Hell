    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                <form name="inpfrm" method="post" action="TestRoomDetailSearch.php">
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="room_detail" name="room_detail" placeholder="Enter Room Detail">
                        </div>
                    </div>
                    <div class="row">

...
<form name="employeeInsertForm" method="post" action="employee_insert.php">
    <table width="500" border="0" align="center" cellpadding="5" cellspacing="0">
        <tr>
            <td colspan="2" align="center"><strong>Employee Form</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="center"><input name="INSERT" type="submit" id="INSERT" value="INSERT"></td>
        </tr>
    </table>
</form>

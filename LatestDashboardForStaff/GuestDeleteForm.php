...
<body>
    ...
    <div class="left">
            <ul>
                ...
                <li class="highlight"><a href="GuestFB.php"><i class="fa-solid fa-book" style="margin-right: 10px;"></i>Guest Information</a></li>

    ...
    <div class="left">
        ...
        <div class="right">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $originalRoomType = mysqli_real_escape_string($con, $_POST['original_room_type']);
                ...
                $updateQuery = "UPDATE room_details SET RoomType = '$updatedRoomType', RoomDetail = '$updatedRoomDetail', RoomPrice = '$updatedRoomPrice' WHERE RoomType = '$originalRoomType'";
            ...
            ?>
                ...
                <?php if ($roomType): ?>
                <form method="post">
                    <!-- Hidden input field to include the original RoomType -->
                    <input type="hidden" name="original_room_type" value="<?php echo $roomType; ?>">

                    <div class="mb-3 row">
                        <label for="room_type" class="col-sm-2 col-form-label text-end">Room Type:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="room_type" name="room_type" value="<?php echo $roomType; ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">

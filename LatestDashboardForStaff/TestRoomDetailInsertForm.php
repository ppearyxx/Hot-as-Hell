        ...
        <div class="right">
            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if (empty($_POST['room_type'])) {
                    ...
                    } elseif (empty($_POST['room_detail'])) {
                        $error_message = "Please Input data Room Detail";
                    } elseif (empty($_POST['room_price'])) {
                        $error_message = "Please Input data Room Price";
                    } else {
                        ...
                        $sql = "INSERT INTO room_details (RoomType, RoomDetail, RoomPrice)
                                VALUES ('$room_type', '$room_detail', '$room_price')";
                ...
                <div style="text-align: center;">
                    ...
                    <form name="inpfrm" method="post" action="">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="room_detail" name="room_detail" rows="5"><?php echo isset($_POST['room_detail']) ? $_POST['room_detail'] : ''; ?></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="room_price" class="col-sm-2 col-form-label text-end">Room Price:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="room_price" name="room_price" value="<?php echo isset($_POST['room_price']) ? $_POST['room_price'] : ''; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col text-end">
                                <button type="submit" class="btn-custom">Insert Room</button>
                                <a href="TestRoomDetailDashboard.php" class="btn btn-secondary-custom">View Inserted Room</a>

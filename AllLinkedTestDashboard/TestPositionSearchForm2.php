...
// Constructing the SQL query to search from any field by the matching string
$query = "SELECT * FROM employee_position WHERE 
          PositionID LIKE '%$search%' OR 
...
?>
            ...
            <div style="width: 100%; display: flex;">
                <a href="TestPositionDashboard.php" style="text-decoration: none;">

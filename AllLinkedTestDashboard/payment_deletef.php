    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div
                ...
                <?php include 'payment_delete.php' ?>
                ...
                <form method="post">
                    ...
                    <p><strong>Earnest Pay Check</strong>: <?php echo $earnestPayCheck; ?></p>
                    ...
                    <p><strong>Earnest Pay Datetime</strong>: <?php echo $earnestPayDatetime; ?></p>
                    <p><strong>Total Pay Datetime</strong>: <?php echo $totalPayDatetime; ?></p>

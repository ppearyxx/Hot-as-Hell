    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                if (empty($PromotionID) && empty($PercentPrice)) {
                    ...
                    if (!empty($PercentPrice)) {
                        $query .= " AND PercentPrice = '$PercentPrice'";
                    }
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<p style='color: red; text-align: center;'>No promotions found matching the criteria.</p>";
                    }
                }
            ...
            <div style="width: 100%; display: flex; justify-content: flex-end;">
                <a href="TestPromotionInsertForm.php">
                    <button style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px; margin-right: 10px;">Insert New Promotion</button>
                </a>

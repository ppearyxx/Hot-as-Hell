    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style="width: 100%; display: flex; justify-content: flex-end;">
                <form name="inpfrm" method="post" action="TestRoomDetailInsertForm.php">
                    <button style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px; margin-right: 10px;" type="submit">Insert New Room Detail</button>
                </form>
                <form name="inpfrm" method="post" action="TestRoomSearchForm.php">
                    <button style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px;" type="submit">Back</button>
                </form>
                <form name="inpfrm" method="post" action="TestRoomDetailDashboard.php">
                    <button style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px; margin-left: 10px;" type="submit">View All Room Details</button>
                </form>
            </div>
        </div>
    </div>

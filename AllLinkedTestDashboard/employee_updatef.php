            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                <form method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="position_id" name="position_id" value="<?php echo $positionID; ?>">
                        </div>
                    </div>  
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        <label for="dob" class="col-sm-2 col-form-label text-end">Gender:</label>
                        <div class="col-sm-10">

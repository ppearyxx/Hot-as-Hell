    ...
    <div class="main">
        ...
        <div>
            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                <form name="inpfrm" method="post" action="TestMethodSearch.php">
                    <div class="mb-3 row">
                        <label for="payment_method_id" class="col-sm-2 col-form-label text-end">Payment Method ID:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="payment_method_id" name="payment_method_id" maxlength="5" placeholder="PM000">
                        </div>
                    </div>
                    <div class="mb-3 row">

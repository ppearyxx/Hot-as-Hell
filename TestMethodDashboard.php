        ...
        <div class="right">
            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                foreach ($result as $row) {
                    ...
                    echo "<td>";
                    echo "<a href='MethodEditForm.php?id=".$row["PaymentMethodID"]."'><button style='color: white; border-radius: 5px; background-color: #00868D; padding: 5px; border: none;'>Edit</button></a> ";
                    echo "<a href='MethodDeleteForm.php?id=".$row["PaymentMethodID"]."'><button style='color: white; border-radius: 5px; background-color: #DC3545; padding: 5px; border: none;'>Delete</button></a>";
                    echo "</td>";
                    echo "</tr>";
                }
                echo "</tbody>";
            ...
            <div style="width: 100%; display: flex; justify-content: flex-end;">
                <a href="MethodInsertForm.php">
                    <button style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px;">Insert New Payment Method</button>
                </a>
                <form name="searchfrm" method="post" action="MethodSearchForm.php" style="margin-left: 10px;">
                    <button type="submit" style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px;">Search For Payment Method</button>
                </form>
            </div>
        </div>
    </div>

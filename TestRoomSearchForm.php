    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                <form name="inpfrm" method="post" action="TestRoomSearch.php">
                    <div class="mb-3 row">
                        <label for="room_id" class="col-sm-2 col-form-label text-end">Room ID:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="room_id" name="room_id" maxlength="5" placeholder="R0000">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="employee_id" name="employee_id" maxlength="12" placeholder="E00000000000">
                        </div>
                    </div>
                    <div class="row">

...
<body>
    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <?php include 'ReservationDelete.php' ?>
                ...
                <div style="text-align: center;">
                    <form method="post">
                        ...
                        <p><strong>Booking NO</strong>: <?php echo $bookingNo; ?></p>
                        <p><strong>Room ID</strong>: <?php echo $roomID; ?></p>
                        <p><strong>Check-In Date</strong>: <?php echo $CheckInDate; ?></p>
                        <p><strong>Check-In Time</strong>: <?php echo $CheckInTime; ?></p>
                        <p><strong>Check-Out Date</strong>: <?php echo $CheckOutDate; ?></p>
                        <p><strong>Check-Out Time</strong>: <?php echo $CheckOutTime; ?></p>

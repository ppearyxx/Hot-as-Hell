    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style="margin-top: 20px; border-radius: 10px; background-color: white; padding: 20px; min-height: 500px; height: 100%;">
                ...
                $query = "SELECT * FROM room WHERE RoomID LIKE '%$RoomID%' AND EmployeeID LIKE '%$EmployeeID%'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    foreach ($result as $row) {
                        ...
                        echo "<td style='color: ".($row["RoomStatus"] == "Available" ? "green" : "red").";'>".$row["RoomStatus"]."</td>";
                        echo "<td>".$row["EmployeeID"]."</td>";
                        echo "<td>";
                        echo "<a href='TestRoomEditForm.php?id=".$row["RoomID"]."'><button style='color: white; border-radius: 5px; background-color: #00868D; padding: 5px; border: none;'>Edit</button></a> ";
                        echo "<a href='TestRoomDeleteForm.php?id=".$row["RoomID"]."'><button style='color: white; border-radius: 5px; background-color: #DC3545; padding: 5px; border: none;'>Delete</button></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='6' style='color: red; text-align: center;'>No rooms found matching the criteria.</td></tr>";
                }
            ...
            <div style="width: 100%; display: flex; justify-content: flex-end;">
                <a href="TestRoomInsertForm.php">
                    <button style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px; margin-right: 10px;">Insert New Room</button>
                </a>
                <form name="searchfrm" method="post" action="TestRoomSearchForm.php">
                    <button type="submit" style="color: white; border-radius: 10px; background-color: #00868D; padding: 10px;">Search For Room</button>
                </form>
            </div>
        </div>
    </div>
